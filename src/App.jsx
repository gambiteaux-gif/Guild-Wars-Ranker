...
function Layout({ children, health }) {
  ...
  return (
    <div className="min-h-screen bg-ink text-stone-100">
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(194,65,45,0.22),transparent_28rem),linear-gradient(135deg,#090706_0%,#160b0b_45%,#24110e_100%)]" />
      <aside className="fixed left-0 top-0 hidden h-full w-72 border-r border-gold/15 bg-black/25 px-5 py-6 backdrop-blur xl:block">
        <Link to="/" className="group block">
          <div className="flex items-center gap-3">
            <div className="grid h-12 w-12 place-items-center rounded border border-gold/40 bg-lacquer/50 shadow-glow">
        ...
        <div className="mt-10 rounded border border-gold/15 bg-black/25 p-4">
      ...
      <header className="sticky top-0 z-20 border-b border-gold/15 bg-ink/85 px-4 py-3 backdrop-blur xl:hidden">
